...
public class WireguardFlutterPlugin: NSObject, FlutterPlugin {
    ...
    public func onRegister(_ registrar: FlutterPluginRegistrar){
        ...
        let messenger = registrar.messenger
        #endif
        let wireguardMethodChannel = FlutterMethodChannel(name: "young.yang.wireguard_2govpn/wgcontrol", binaryMessenger: messenger)
        let vpnStageE = FlutterEventChannel(
      name: "young.yang.wireguard_2govpn/wgstage", binaryMessenger: messenger)
